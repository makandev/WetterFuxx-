...
self.addEventListener('fetch', (e) => {
  ...
  if (/open-meteo\.com|bigdatacloud\.net|brightsky\.dev|api\.rainviewer\.com|photon\.komoot\.io|eonet\.gsfc\.nasa\.gov|earthquake\.usgs\.gov/.test(url.hostname)) {
    e.respondWith(
      fetch(req).then((res) => {
